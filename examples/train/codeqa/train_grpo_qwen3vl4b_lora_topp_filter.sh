#!/bin/bash
# GRPO training: Qwen3-VL-4B + LoRA + topp filter on CodeQA (vision, 2-turn)
...
#   bash examples/train/codeqa/train_grpo_qwen3vl4b_lora_topp_filter.sh

set -x

# vLLM v1 engine has a LoRA bug in determine_available_memory;
# fall back to v0 engine until fixed
export VLLM_USE_V1=0

PROJECT_NAME="vagen_experiments"
EXPERIMENT_NAME="codeqa_grpo_qwen3vl4b_lora_topp_filter"
